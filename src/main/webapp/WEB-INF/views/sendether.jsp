		...
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav side-nav">
				<li><a href="mywallet"><i class="fa fa-google-wallet" aria-hidden="true"></i>
						My Wallet</a></li>
				<li class="active"><a href="#"><i class="fa fa-paper-plane" aria-hidden="true"></i>
						Send Ether</a></li>
		   			...
		   			<div class="breadcrumb">
						<div class="panel panel-info" >
							<div class="panel-heading">
		                     	<div class="panel-title">Send Ether</div>
		                 	</div>
		                 	<div class="panel-body">
		                 		<form class="form-horizontal" role="form" action="sendEtherToRecipient" method="post" id="sendEtherForm">
		                 			<div class="form-group">
										<div class="col-sm-2">
											<span>Balance</span> 
										</div>
										<div class="col-sm-6">
											<input type="text" id="currentbalance" name="currentbalance"
													placeholder="e.g., 10.0" class="form-control" value="${myBalance} ETH" readonly="readonly">
										</div>
									</div>
									<div class="form-group">
										<div class="col-sm-2">
										...
										<div class="col-sm-6">
											<input type="text" id="toaddress" name="toaddress"
													placeholder="e.g., 0x12345..." class="form-control" autofocus required>
										</div>
									</div>
		                 			<div class="form-group">
										<div class="col-sm-2">
									...
									<div class="form-group">
										...
										<div class='col-sm-2'>
											...
											<input type="button" value="Send" onclick="sendEtherConfirmation();">
											<!-- <button>Buy</button> -->
										</div>
									</div>
		                 		</form>

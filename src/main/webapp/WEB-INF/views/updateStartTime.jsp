		   			...
		   			<div class="breadcrumb">
						<div class="panel panel-info" >
							<div class="panel-heading">
		                     	<div class="panel-title">Update Crowdsale (ICO) Start Time</div>
		                 	</div>
		                 	<div class="panel-body">
		                 		<form class="form-horizontal" role="form" action="updateTokenStartTime" method="post" id="updateTokenForm">
									...
									<div class="form-group">
										...
										<div class='col-sm-6'>
											<input type="datetime-local" id="launchDate" name="launchDate" class="form-control" required></input>
										</div>
									...
									<div class="form-group">
										...
										<div class='col-sm-6'>
											<input type="datetime-local" id="endTime" name="endTime" class="form-control" value="${endTime}" readonly="readonly"></input>
										</div>
